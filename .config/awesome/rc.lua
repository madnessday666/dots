...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "t", function () awful.spawn(terminal) end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ modkey,           }, "d", function () awful.spawn.with_shell("rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/rofi/theme.rasi") end,
              {description = "open app menu", group = "rofi"}),
    awful.key({ modkey,           }, "a", function () awful.spawn("firefox") end,
              {description = "launch firefox", group = "launcher"}),
    awful.key({ "Control", "Shift"  }, "l", function () awful.spawn.with_shell("xscreensaver-command -lock") end,
              {description = "launch firefox", group = "launcher"}),
...
awful.spawn.with_shell("xrandr --output DisplayPort-1 --off")
awful.spawn.with_shell("xscreensaver --no-splash")
awful.spawn.with_shell("feh --bg-scale ~/Downloads/skyblu.png")
awful.spawn.with_shell("sh .config/polybar/launch.sh && compfy --daemon --config ~/.config/compfy/compfy.conf")
